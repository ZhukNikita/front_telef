    ...
    <div className={styles.mainContent}>
      <div className={styles.header}>
        ...
        <div className={styles.localNumbers}>
          <div className={styles.content}>
            <motion.h3 initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration : 0.9 ,delay: 0.3}}>Local numbers in 67 countries</motion.h3>
            <motion.p initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration : 0.9 ,delay: 0.3}}>We provision and port single numbers, ranges and 100- or 1,000- blocks worldwide.
